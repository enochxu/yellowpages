  ...
  return (
    <div className="results">
      ...
      <div className="results-grid">
        <Card name="Ackerman Grand Ballroom" ratingValue="4.7"  image="https://i.ibb.co/2c90ZNw/ackerman-bathroom.jpg" distance="0.0 mi away" url="/samples/ackerman"/>
        <Card name="Ackerman Level 1" ratingValue="3.5" image="https://i.ibb.co/GRmDHyy/ackerman1entrancemens.jpg" distance="1.0 mi away" url="/samples/ackermanl1"/>
