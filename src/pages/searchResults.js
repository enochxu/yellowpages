  ...
  return (
    <div className="results">
      ...
      <div className="results-grid">
        ...
        <Card name="Ackerman Level 1" ratingValue="1.0" image="https://i.ibb.co/GRmDHyy/ackerman1entrancemens.jpg" distance="1.0 mi away"/>
        <Card name="Powell Library Basement" ratingValue="3.2" image="https://i.ibb.co/SxLzd7m/powellstalls.jpg" distance="0.2 mi away"/>
        <Card name="Kaplan Level 1" ratingValue="5.0" image="https://i.ibb.co/6sKbXx3/kaplan1stallswomen.jpg" distance="0.2 mi away"/>
      </div>
    </div>
  )
}
