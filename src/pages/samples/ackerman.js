...
const Ackerman = () => {
  const reviews = [
    ...
    },
    {
      ...
      rating: "5.0",
      reviewText:
        "This bathroom has more stalls than my instagram followers. Potential party venue.",
      type: "men",
    },
    {
      name: "Ackerman Grand Ballroom",
      rating: "5.0",
      reviewText:
        "The capacity of these bathrooms is actually incredible. Perfect for students and families that are touring, but also big enough that it doesn’t annoy us students who actually go here.",
      type: "women",
    },
    {
      name: "Ackerman Grand Ballroom",
      rating: "5.0",
      reviewText:
        "This bathroom has a diaper changing station! It’s a very large and roomy bathroom which was super helpful. What a life saver.",
      type: "women",
    },
    {
      name: "Ackerman Grand Ballroom",
  ...
  const images = [
    ...
    "https://ibb.co/44cb8RS", // gender-neutral toilet
  ];
